package performance.com.example.ndh.constraintlayoutdemo;
...
public class CircleViewBehivor extends CoordinatorLayout.Behavior<CircleImageView> {
    ...
    public boolean onDependentViewChanged(CoordinatorLayout parent, CircleImageView child, View dependency) {
        android.util.Log.d("ndh--", "child=" + child.getY() + "," + child.getScrollY() + "," + child.getTranslationY());
        android.util.Log.d("ndh--", "dependency=" + dependency.getY() + "," + dependency.getScrollY() + "," + dependency.getTranslationY());
